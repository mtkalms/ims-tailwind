...
export const DEFAULT_INCIDENTS = {
  1: {
    title: "Forgot keys at home",
    description: "I forgot my keys at home",
    status: "open",
    project: 0,
  },
  2: {
  ...
  6: {
    title: "Broken window",
    description: "I have a broken window",
    status: "open",
    project: 1,
  },
  7: {
    title: "Power outage",
    description: "I have a power outage",
    status: "open",
    project: 0,
  },
  8: {
    title: "Water leak",
    description: "I have a water leak",
    status: "open",
    project: 1,
  },
  9: {
    title: "Internet outage",
    description: "I have an internet outage",
    status: "open",
    project: 0,
  },
};
